    ...
    <div className=" min-h-screen overflow-x-hidden overflow-y-hidden">
      ...
      >
        <div className="text-center mb-16">
          <h1 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600 mb-4">
            Meet Our Team
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              transition={{ delay: 0.2 + index * 0.2, duration: 0.1 }}
